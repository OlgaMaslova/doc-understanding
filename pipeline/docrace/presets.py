...
now the page has to describe a run *before* the first one: name the seven approaches
so you can pick some, and count the questions so it can tell you what it will cost.
